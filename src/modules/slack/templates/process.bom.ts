...
let bomHeader: SlackBomHeader = {
	...
	text: {
		type: "mrkdwn",
		text: "You have triggered the ${CICD_PROCESS_NAME} Process with dry run mode  ${DRYN_RUN}, For the *Gravitee APIM Release* version *3.8.0*. Here below is the B.O.M. (Bill of Material) of that release.\n\n *Please check that the Release B.O.M. (Bill of Material) is Ok, and in Circle CI Web UI, Approve or Cancel The Job on hold :*"
	}
}
